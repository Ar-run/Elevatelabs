Loaded the csv file into a dataframe using read_csv() method
Checked for null values using isna().sum() method
Handled missing values using Mean and Median imputation techniques
